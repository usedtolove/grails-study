...
<html>
    ...
    <body>
        ...
        <div id="show-department" class="content scaffold-show" role="main">
            ...
            <g:form resource="${department}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${department}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
